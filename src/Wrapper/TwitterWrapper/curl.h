...
#include "../../Wrapper/TwitterWrapper/curlver.h"
#include "../../Wrapper/TwitterWrapper/curlbuild.h"
#include "../../Wrapper/TwitterWrapper/curlrules.h"
...
#include "../../Wrapper/TwitterWrapper/easy.h"
#include "../../Wrapper/TwitterWrapper/multi.h"

/* the typechecker doesn't work in C++ (yet) */
#if defined(__GNUC__) && defined(__GNUC_MINOR__) && \
    ((__GNUC__ > 4) || (__GNUC__ == 4 && __GNUC_MINOR__ >= 3)) && \
    !defined(__cplusplus) && !defined(CURL_DISABLE_TYPECHECK)
#include "../../Wrapper/TwitterWrapper/typecheck-gcc.h"
#else
