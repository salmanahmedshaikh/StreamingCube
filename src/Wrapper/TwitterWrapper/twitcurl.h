...
#include <cstring>
#include <vector>
#include "../../Wrapper/TwitterWrapper/oauthlib.h"
...
public:
	...
	/*stream api*/
	bool sampleStreamGet(size_t (*callbackfunction)(void *ptr, size_t size, size_t nmemb, void *s),void* callbackargument);
    /* Clones this object */
    twitCurl* clone();
...
private:
	...
	bool performStreamGet( const std::string& getUrl ,size_t (*callbackfunction)(void *ptr, size_t size, size_t nmemb, void *s) ,void* callbackargument );
