...
def setConfigurationFile(outputFile, IoI, MNodes, SystemExecSeconds):
    ...
    #file3 = open('/home/jsspinner/jsspinnerTimeBasedDistributedjsspinnerTimeBasedDistributed_OLAP/jsonstream/configure/JStreamSpinner.conf', 'w')
    file3 = open('/home/salman/jsspinnerTimeBasedDistributed/jsonstream/configure/JStreamSpinner.conf', 'w')
    wrapper_folder = "wrapper_folder = ./configure/wrapper\n"
    file3.write(wrapper_folder)
    file3.write("query_index = 0" + "\n")
    file3.write("query_source = 1" + "\n")
    file3.write("num_queries = 1" + "\n")
    file3.write("node_type = 0" + "\n")
    file3.write("stream1_window_size = 1000" + "\n")
    file3.write("stream2_window_size = 10000" + "\n")
    file3.write("stream3_window_size = 1000" + "\n")
    file3.write("stream1_input_rate = 0.2" + "\n")
    file3.write("stream2_input_rate = 500000" + "\n")
    file3.write("stream3_input_rate = 0.2" + "\n")
    file3.write("IoI = " + IoI + "\n")
    file3.write("SystemExecSeconds = " + SystemExecSeconds + "\n")
    file3.write("activate_duration = 0millisecond" + "\n")
    file3.write("node_type = 0" + "\n")
    file3.write("server_port = 9088" + "\n")
    file3.write("worker_command_port = 9085" + "\n")
    file3.write("worker_status_port = 9090" + "\n")
    file3.write("worker_data_port = 9095" + "\n")
    file3.write("simulator_stream_port = 9999" + "\n")
    file3.close()

    #file4 = open('/home/jsspinner/jsspinnerTimeBasedDistributed_OLAP/jsonstream/configure/cubify.conf', 'w')
    file4 = open('/home/salman/jsspinnerTimeBasedDistributed/jsonstream/configure/cubify.conf', 'w')
    #file4.write("DimensionNames = Product, Supplier, Promotion, Customer, Store, SalesPerson" + "\n")
    #file4.write("Dimensions = prodID, suppID, promoID, custID, storeID, SalesPersonID" + "\n")
    file4.write("DimensionNames = Part, Supplier, Customer, Store" + "\n")
    file4.write("Dimensions = partKey, suppKey, custKey, storeKey" + "\n")
    file4.write("DimensionSizes = 250, 4, 5, 7" + "\n")
    file4.write("MMode = Frequency" + "\n")
    file4.write("MVerticesNum = " + MNodes + "\n")
    file4.write("RFMode = Custom" + "\n")
    file4.write("RefFrequencies = 58, 73, 85, 4, 1, 13, 72, 82, 51, 18, 97, 6, 58, 60, 61, 27, 71, 83, 28, 55, 56, 78, 50, 57, 89, 43, 39, 13, 27, 95, 87, 53, 13, 29, 63, 16, 56, 37, 50, 74, 46, 52, 43, 60, 45, 18, 12, 42, 92, 1, 65, 17, 92, 24, 64, 61, 48, 81, 19, 85, 35, 70, 67, 98, 40, 78, 14, 74, 76, 97, 58, 45, 91, 29, 29, 45, 17, 88, 42, 12, 86, 32, 41, 25, 55, 65, 100, 24, 51, 60, 44, 1, 4, 78, 94, 74, 11, 20, 50, 68" + "\n")
    file4.write("MVertices = custKey, partKey | partKey | custKey" + "\n")
    file4.write("MaxStorageNumTuples = 2147483647" + "\n")
    file4.write("OptMethod = MaxStorage" + "\n")
    file4.write("TimeGrain = Second" + "\n")
    file4.close()
...
def runSystem():
	...
	#return execCmd('cd ..;cd ..;(./main.exe & /home/salman/jsspinnerTimeBasedDistributed_OLAP/jsonstream/main.exe);')
    return execCmd('cd ..;cd ..;./main.exe & (cd; cd jsspinnerTimeBasedDistributed/; cd jsonstream; ./main.exe);')

def openTestResultFile():
    #file = open('streamingCubeUnified.txt','w')
    #file = open('streamingCubeUnified_SPE_OLAP.txt','w')
    file = open('streamingCubeUnified_SPE_OLAP_TPCH.txt','w')
    file.truncate()
    file.close()
    #file = open('streamingCubeUnified.txt','w')
    #file = open('streamingCubeUnified_SPE_OLAP.txt','w')
...
def main():
    ...
    IoIList = ["30000","60000","90000","120000"]
    #SystemExecSecondsList = ["20","20","20","20"]
    SystemExecSecondsList = ["60","120","1800","2400"]
    ...
    for idx, IoI in enumerate(IoIList):
        ...
        for MNodes in MNodesList:
            ...
            setConfigurationFile(file, IoI, MNodes, SystemExecSeconds)
            storageResultList = []
            queryingResultList = []
            ...
            for i in range(experimentTimes):
                ...
                #networkLoad = float (outputValues[0])
